        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Referrals List</a></li>
                </ol>
                     <div class="page-title-right">
                        <a class="btn btn-danger waves-effect waves-light" href="{{url('admin/customers/')}}"> Back</a>
                    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3>Referrals List of {{$user->name}}({{$user->username}})</h3>
                        ...
                        <tbody>
                          @foreach($childrens as $user)
                            <tr class="default @if($loop->index % 2 ===0)even @else odd @endif">
                                <td>{{ $childrens->firstItem() + $loop->index }}</td>
                                <td>{{$user->username}}</td>
