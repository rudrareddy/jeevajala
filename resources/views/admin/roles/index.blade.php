        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a class="btn btn-danger waves-effect waves-light" href="{{url('admin/roles/create')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
                </div>
                                ...
                                <td>
                                    <div class="actionParent">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <li><a class="dropdown-item" href="{{url('admin/roles/'.$role->id.'/edit')}}"><i class="fa fa-edit"></i> Edit</a></li>
                                           <!-- <form action="{{url('admin/roles/'.$role->id)}}" class="delete-form-banner" method="POST">
                                                            {{ method_field('DELETE') }}{{csrf_field()}}
                                            <li><button class="dropdown-item text-danger delete-btn-banner" type="button" data-url="{{ url('admin/roles/'.$role->id) }}"><i class="fa fa-trash"></i> Delete</button></li>-->
                                        </ul>
                                    </div>
                                </td>
                            </tr>
