                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required name="name" id="formrow-password-input"  value="{{old('name')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label" for="formrow-password-input">Display Name</label>
                                    <input type="text" class="form-control" required name="display_name" id="formrow-password-input"  value="{{old('display_name')}}">
                                </div>
                            </div>
                        </div>
                        <div class="mt-4">
