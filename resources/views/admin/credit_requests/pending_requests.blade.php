        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item ">Pending Requests</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                        ...
                        @if(request('search'))
                        <button class="btn btn-danger"><a href="{{ url('admin/pending-credit-requests') }}" class="text-sm text-gray-500">Clear</a></button>
                        @endif
                    </div>
                <div class="card-body">
